...
/*/
void cadastrarAluno(Cadastro *aluno){
  
FAZER FUNÇÃO PARA CADASTRO DE ALUNOS

}
/*/

int main(void){
  Cadastro Aluno[MAX_ALUNO], Professor[MAX_PROFESSOR];
  int qtdAluno = 0;
  int opcao;
  int sair = 0;
  ...
  // PONTO PARA REVISAR: COMO BLOQUEAR O CADASTRO CASO A MATRÍCULA JÁ EXISTA
            ...
            //MUDAR PRINTF DE STRING PARA FPUTS/FGETS
            case 2:{
              printf("Listar Aluno\n");
              if (qtdAluno == 0)
                printf("Lista vazia\n");
            ...
            /// PAREI AQUI (Antes de tudo, criar função de cadastro de aluno)
